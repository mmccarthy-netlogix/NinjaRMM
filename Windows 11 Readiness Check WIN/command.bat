...
$outputToUDF = "Windows 11: $([pscustomobject]$outObject.returnResult). Info: $([pscustomobject]$outObject.Logging)" 
$outputToUDF

if([bool]$ENV:UDFOutput -eq $true){
REG ADD HKEY_LOCAL_MACHINE\SOFTWARE\CentraStage /v Custom$($ENV:UDFNUMBER) /t REG_SZ /d $outputToUDF /f
}
