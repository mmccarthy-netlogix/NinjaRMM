...
$swList1=Get-ItemProperty HKLM:\Software\Wow6432Node\Microsoft\Windows\CurrentVersion\Uninstall\* | Where-Object {$_.DisplayName -like "PLTW Kite Student Portal*"}
$swList2=Get-ItemProperty HKLM:\Software\Microsoft\Windows\CurrentVersion\Uninstall\* | Where-Object {$_.DisplayName -like "PLTW Kite Student Portal*"}
...
$NULL > $ENV:Programdata\CentraStage\NetLogix\PLTWkite.install

Remove-Item C:\Users\sciencelab\AppData\Roaming\ATSPLTW -Recurse -Force
